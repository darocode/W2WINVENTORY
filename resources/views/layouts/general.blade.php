    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Configuración</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ url('/unityMeasurement') }}">
              <i class="bi bi-circle"></i><span>Unidades de medida</span>
            </a>
          </li>
          <li>
            <a href="{{ url('/typeClient') }}">
              <i class="bi bi-circle"></i><span>Tipo clientes</span>
            </a>
          </li>
          <li>
            <a href="{{ url('/typeUser') }}">
