...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <!--Search sector master-->
            <input type="search" class="form-control" id="search" class="search" name="search" placeholder=" Buscar maestro sector" >  
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form id="formulario" method="POST">
                            ...
                            <div class="modal-footer">
                                <button type="button" id="cerrar_ma " class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                <button type="button" id= "actualizar_ma" class="btn btn-warning editar">Actualizar</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                success:function(res){
                    ...
                    $.each(res, function(index, value){
                        tableRow= '<tr>\
                                ...
                                <td><button type="button" value="'+value.id+'" class="btn btn-warning editsMas">Editar</button></a>\
                                    <button type="button" value="'+value.id+'" class="btn btn-danger deletesMas">Eliminar</button></a></td>\
                                </tr>'
