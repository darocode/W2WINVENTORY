...
<!-- Script Ajax -->
    <script>
        ...
        $('body').on('keyup', '#search',function(){
            ...
            $.ajax({
                method: 'POST',
                url: '{{ route("sectionSearch.action") }}',
                dataType: 'json',
                data : {
                    '_token' : '{{ csrf_token() }}',
                ...
                success:function(res){
                    ...
                    $.each(res, function(index, value){
                        tableRow= '<tr>\
                                <td>'+value.nameSection+'</td>\
                                <td><button type="button" value="'+value.id+'" class="btn btn-warning editSect">Editar</button></a>\
                                    <button type="button" value="'+value.id+'" class="btn btn-danger deleteSect">Eliminar</button></a></td>\
                                </tr>'
