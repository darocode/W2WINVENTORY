...
class CountriesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $mensajes = [
            "nameCountry.required" => "El nombre del país es obligatorio",
            "nameCountry.string" => "El campo pais solo permite letras",
        ];
    ...
    {
        $post = DB::table('countries')->where('nameCountry','like','%'.$request->get('searchQuest').'%')->get();
